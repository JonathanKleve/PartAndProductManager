...
public class reportMenuController {
    ...
    public void onGoButton1Click(ActionEvent actionEvent) throws IOException {
        SceneNavigator.loadScene(actionEvent, "/kleve/testtwo/part-report-view.fxml", "Part Report");
    }
    ...
    public void onGoButton2Click(ActionEvent actionEvent) throws IOException {
        SceneNavigator.loadScene(actionEvent, "/kleve/testtwo/product-report-view.fxml", "Product Report");
    }
    ...
    public void onGoButton3Click(ActionEvent actionEvent) throws IOException {
        SceneNavigator.loadScene(actionEvent, "/kleve/testtwo/week-updated-report-view.fxml", "Week Updated Report");
    }
}