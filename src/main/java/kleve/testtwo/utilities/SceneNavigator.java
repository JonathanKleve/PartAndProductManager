package kleve.testtwo.utilities;
...
public class SceneNavigator {
    ...
    public static void navigateToMainMenu(ActionEvent event) throws IOException {
        loadScene(event, "/kleve/testtwo/main-menu-view.fxml", "Inventory Management System - Main Menu");
    }
    ...
    public static void navigateToReportMenu(ActionEvent event) throws IOException {
        loadScene(event, "/kleve/testtwo/report-menu-view.fxml", "Report Menu");
    }
}
